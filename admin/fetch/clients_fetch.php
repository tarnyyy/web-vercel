...
while ($row = $data_result->fetch_assoc()) {
    $clients .= "
        <tr>
            <td><input type='checkbox' class='deleteCheckbox' style='vertical-align:middle;' name='selected_ids[]' value='{$row['id']}'></td>
            ...
            <td style='vertical-align: middle;'>
                ...
                <a class='btn btn-danger btn-sm someText' style='padding: 5px;' href='#'
                    onClick='confirmDelete(\"clients.php?deleteClient={$row['id']}\")'>
