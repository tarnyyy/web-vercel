...
$count_query = "SELECT COUNT(*) AS total FROM reservations
                ...
                OR check_in LIKE '%$query%'
                OR check_out LIKE '%$query%'
...
$data_query = "SELECT reservation_id, client_id, room_id, check_in, check_out, total_price, type, reservation_status FROM reservations 
               WHERE reservation_id LIKE '%$query%' 
                  OR client_id LIKE '%$query%'
                  OR room_id LIKE '%$query%'
                  OR check_in LIKE '%$query%'
