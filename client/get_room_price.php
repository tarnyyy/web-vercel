...
// Debugging log: print the room_id received in the request
error_log("Received room_id: " . $roomId);
...
if ($roomId > 0) {
    ...
    if ($stmt = $mysqli->prepare($query)) {
        ...
        // Debugging log: print the room price fetched from the database
        error_log("Fetched room_price: " . $roomPrice);
